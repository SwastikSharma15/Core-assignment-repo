  ...
  return (
    <div className="flex flex-col h-full p-4 md:p-6 gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        {/* Search */}
        <div className="flex items-center gap-3 px-4 py-3 rounded-full border border-[#E5E5E4] flex-1 max-w-[350px]">
          <Search className="w-4 h-4 flex-shrink-0 text-[#3D3936]" />
          <input
              type="text"
        ...
        <div className="flex items-center justify-between sm:justify-end gap-4">
          <div className="flex items-center gap-2">
            {/* Download */}
            <button
              className="w-12 h-12 flex items-center justify-center rounded-[14px] border border-[#E5E5E4]"
            >
          ...
          {/* Add button */}
          <button
            className="w-12 h-12 flex items-center justify-center rounded-[14px] bg-[#3D3936]"
          >
          ...
          {/* View toggle */}
          <div
            className="flex items-center gap-1 p-1 rounded-[14px] border border-[#E5E5E4]"
          >
            <button
              className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#3D3936]"
            >
      ...
      {/* Pagination */}
      <div
        className="flex flex-wrap items-center gap-2 md:gap-4 pt-2 text-sm text-[#3D3936] font-sans"
      >
        <div className="flex items-center gap-2">
          <span className="font-medium hidden sm:inline">Rows per page:</span>
          <div
            className="flex items-center gap-1 px-3 py-1 rounded-md cursor-pointer border border-[#E5E5E4]"
          >
