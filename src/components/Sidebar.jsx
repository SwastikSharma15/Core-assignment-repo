          ...
          <div className="w-5 h-5 flex items-center justify-center">
            {label === 'Home' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <path d="M7.5 1L1 6.5V14h5v-4h3v4h5V6.5L7.5 1z" stroke="#fff" strokeWidth="1.5" strokeLinejoin="round" fill="none"/>
              </svg>
            )}
            {label === 'My Info' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <circle cx="7.5" cy="5" r="3" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M2 14c0-3 2-5 5.5-5s5.5 2 5.5 5" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
              </svg>
            )}
            {label === 'People' && (
              <img src="https://cdn.codia.ai/figma/DePpmENkOZKjPqaaNjYGwO/img-de3ffafb7171d2b1.svg" alt="" className="w-4 h-4" />
            )}
            {label === 'Team Management' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <circle cx="5" cy="5" r="2.5" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M1 13c0-2.5 1.8-4 4-4" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                <circle cx="11" cy="5" r="2" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M9 13c0-2 1.3-3 3-3" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
              </svg>
            )}
            {label === 'Project Setup' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <rect x="2" y="1" width="11" height="13" rx="2" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M5 5h5M5 8h5M5 11h3" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
            )}
            {label === 'Hiring' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <circle cx="6" cy="5" r="2.5" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M1 13c0-2.5 1.8-4 4.5-4" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                <path d="M12 8v5M9.5 10.5h5" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
            )}
            {label === 'Report' && (
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                <rect x="1" y="1" width="13" height="13" rx="2" stroke="#fff" strokeWidth="1.5" fill="none"/>
                <path d="M4 10l2.5-3 2.5 2 2.5-4" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            )}
          </div>
          <span
  ...
  return (
    <>
      ...
      <div className="px-4 mt-auto">
        <div
          className="flex items-center gap-3 px-4 py-4 rounded-xl cursor-pointer border border-white/10"
        >
